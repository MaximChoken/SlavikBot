...
API_TOKEN = '7619047329:AAGRqXE9nbEra77X3D6MdDJTB0COOQUTd6s'
...
def send_welcome(message):
    welcome_text = (
        "Здарова, приятель!\n"
        "Меня зовут Вячеслав или просто Славик, я радостью поговорю с тобой и отвечу на вопросы, используй эти команды:\n"
